...
export class v41643234758707 implements MigrationInterface {
    name = 'v41643234758707'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`ticket\` CHANGE \`type\` \`subject\` varchar(100) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`service\` DROP COLUMN \`tittle\``);
        await queryRunner.query(`ALTER TABLE \`association\` ADD \`name\` varchar(20) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`service\` ADD \`title\` varchar(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`service\` ADD \`associationIdId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`association\` CHANGE \`created_at\` \`created_at\` datetime NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`association\` CHANGE \`user_id\` \`user_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`service\` DROP COLUMN \`associationIdId\``);
        await queryRunner.query(`ALTER TABLE \`service\` DROP COLUMN \`title\``);
        await queryRunner.query(`ALTER TABLE \`association\` DROP COLUMN \`name\``);
        await queryRunner.query(`ALTER TABLE \`service\` ADD \`tittle\` varchar(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`association\` ADD \`Name\` varchar(20) NOT NULL`);
        await queryRunner.query(`DROP TABLE \`ticket_responses\``);
        await queryRunner.query(`ALTER TABLE \`ticket\` CHANGE \`subject\` \`type\` varchar(100) NULL DEFAULT 'NULL'`);
    }
