...
export class v51643241659908 implements MigrationInterface {
    name = 'v51643241659908'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_143bae860ce1bae7a8532627122\` ON \`favorite\``);
        await queryRunner.query(`DROP INDEX \`FK_05444190acb50a244174dc70e01\` ON \`favorite\``);
        await queryRunner.query(`DROP INDEX \`FK_735db187ef67b85845cdf4c2bf3\` ON \`ticket\``);
        await queryRunner.query(`DROP INDEX \`FK_12e3d08fe1242623310ecffb3b1\` ON \`ticket\``);
        await queryRunner.query(`DROP INDEX \`FK_8599227b7e110597f53a1f34762\` ON \`image\``);
        await queryRunner.query(`DROP INDEX \`FK_3dd21505bf38aeefe2e7fe6d404\` ON \`payment\``);
        await queryRunner.query(`DROP INDEX \`FK_5e27aa5c530447ca6eecca4967b\` ON \`service\``);
        await queryRunner.query(`DROP INDEX \`FK_76f954b0122c58a298dc4f4d9d6\` ON \`subscription\``);
        await queryRunner.query(`DROP INDEX \`FK_632356bdd9bafd8079c702fcdc9\` ON \`subscription\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_632356bdd9bafd8079c702fcdc9\` ON \`subscription\` (\`serviceIdId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_76f954b0122c58a298dc4f4d9d6\` ON \`subscription\` (\`userIdId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_5e27aa5c530447ca6eecca4967b\` ON \`service\` (\`associationIdId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_3dd21505bf38aeefe2e7fe6d404\` ON \`payment\` (\`userIdId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_8599227b7e110597f53a1f34762\` ON \`image\` (\`ticketIdId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_12e3d08fe1242623310ecffb3b1\` ON \`ticket\` (\`supportIdId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_735db187ef67b85845cdf4c2bf3\` ON \`ticket\` (\`userIdId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_05444190acb50a244174dc70e01\` ON \`favorite\` (\`associationIdId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_143bae860ce1bae7a8532627122\` ON \`favorite\` (\`userIdId\`)`);
    }
