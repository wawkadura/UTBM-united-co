    ...
    return <div className="services" id="services">
        ...
        <div className="p-d-flex p-jc-evenly services-card">
            <div className="p-mr-4">
                <img className="image-services" src={toward} alt="image-toward"/>    
            ...
            <div className="p-mr-4">
                <img className="image-services" src={statistic} alt="image-statistic"/> 
            ...
            <div className="p-mr-4">   
                <img className="image-services " src={all_assoc} alt="image-all_assoc"/>    
